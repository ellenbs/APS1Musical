...
#define START_IDX 28
#define START_IDX_MASK (1u << START_IDX)

#define SELECAO_PIO PIOC
#define SELECAO_PIO_ID ID_PIOC
#define SELECAO_IDX 31
#define SELECAO_IDX_MASK (1u << SELECAO_IDX)

#define BUZZER_PIO PIOA
#define BUZZER_PIO_ID ID_PIOA
#define BUZZER_IDX 2
#define BUZZER_IDX_MASK (1u << BUZZER_IDX)
